...
docker run -it \
  ...
  -w /home/akanu \
  -v $HOME/akanu/projects/Projects_to_make_public/Leveraging-Trajectory-Prediction-for-Pedestrian-Video-Anomaly-Detection:/home/akanu \
  leveraging_traj_pred_anom_det:latest
